...
import { parseComments } from "../src/utils/comments.js";
...
describe("comment helpers", () => {
  it("parses structured reservation comments generated by the middleware", () => {
    expect(
      parseComments(
  ...
  it("keeps unstructured comments as notes", () => {
    expect(parseComments("Cliente pide mesa tranquila")).toEqual({
      notes: "Cliente pide mesa tranquila",
    });
  });
});

...
function summarizeReservation(reservation) {
  ...
  return {
    ...
    email: stringOrNull(reservation.email),
    identityDocument: stringOrNull(reservation.identityDocument),
    countryCode: stringOrNull(reservation.indicativo || reservation.countryCode),
    country: stringOrNull(reservation.country),

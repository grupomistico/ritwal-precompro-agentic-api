export const toolSpecs = [
        ...
        criteria: {
          ...
          properties: {
            ...
            country: {
              ...
              items: { type: "string" },
              description:
                "Pais reportado por Precompro en el contacto. Ej: Colombia, Canada, United States.",
            },
            countryCode: {
              type: ["array", "string"],
              items: { type: "string" },
              description:
                "Codigo/indicativo de pais reportado por Precompro. No asumir ISO.",
            },
            nationality: {
              type: ["array", "string"],
              items: { type: "string" },
              description:
                "Alias de country para lenguaje natural. No es nacionalidad legal verificada.",
            },
            nationalityCode: {
              type: ["array", "string"],
              items: { type: "string" },
              description: "Alias de countryCode para lenguaje natural.",
            },
            locality: {
              type: ["array", "string"],
              items: { type: "string" },
              description: "colombia, international o unknown.",
            },
            sectionName: { type: ["array", "string"], items: { type: "string" } },
            tableName: { type: ["array", "string"], items: { type: "string" } },
            source: { type: ["array", "string"], items: { type: "string" } },
  ...
  },
  {
    ...
    method: "POST",
    path: "/tools/customers/demographics",
    description:
      "Reporte interno de demografia de clientes desde reservas Precompro. Agrupa por pais/codigo/localidad y devuelve agregados sin PII por defecto. Usar para preguntas como nacionalidades, paises, visitantes extranjeros o distribucion demografica.",
    inputSchema: {
      type: "object",
      required: ["from", "to"],
      additionalProperties: false,
      properties: {
        from: { type: "string", description: "Fecha inicial en YYYY-MM-DD." },
        to: { type: "string", description: "Fecha final en YYYY-MM-DD." },
        includeCancelled: { type: ["boolean", "string", "number"], default: true },
        groupBy: {
          type: ["array", "string"],
          items: {
          ...
          default: ["country"],
          description:
            "Dimensiones para agrupar. Preferir country para paises/nacionalidades y locality para Colombia vs extranjeros.",
        },
        includeCustomers: {
          type: ["boolean", "string", "number"],
          default: false,
          description:
            "Si true incluye clientes con PII paginada; dejar false para reportes demograficos agregados.",
        },
        includeReservations: {
          type: ["boolean", "string", "number"],
          default: false,
          description: "Solo aplica cuando includeCustomers=true.",
        },
        limit: {
          type: ["integer", "string"],
          minimum: 1,
        ...
        criteria: {
          ...
          additionalProperties: false,
          description:
            "Mismos filtros de customer_segment. Para filtrar por pais usar country; para extranjeros usar locality=international.",
          properties: {
            minTotalReservations: { type: ["integer", "string"], minimum: 0 },
            maxTotalReservations: { type: ["integer", "string"], minimum: 0 },
            minCompletedReservations: { type: ["integer", "string"], minimum: 0 },
            ...
            hasCompleted: { type: ["boolean", "string", "number"] },
            hasPending: { type: ["boolean", "string", "number"] },
            country: { type: ["array", "string"], items: { type: "string" } },
            countryCode: { type: ["array", "string"], items: { type: "string" } },
            nationality: { type: ["array", "string"], items: { type: "string" } },
            nationalityCode: { type: ["array", "string"], items: { type: "string" } },
            locality: { type: ["array", "string"], items: { type: "string" } },
            sectionName: { type: ["array", "string"], items: { type: "string" } },
            tableName: { type: ["array", "string"], items: { type: "string" } },
            source: { type: ["array", "string"], items: { type: "string" } },
            provider: { type: ["array", "string"], items: { type: "string" } },
